    ...
    <Fragment>
      <div className="row justify-content-center">
        <Col xxl={12} xl={12} lg={12} md={12} xm={12}>
          <Card className="custom-card overflow-hidden rounded-0">
            <Card.Body className="p-0">
              <div className="contact-page-banner">
                <div className="text-center">
                  <h3 className="fw-semibold text-fixed-white">Contact US !</h3>
                  <h6 className="text-fixed-white mb-4 px-sm-0 px-3">
                    Have any questions ? We would love to hear from you.{" "}
                  </h6>
                  <button className="btn btn-success btn-wave">
                    Contact <i className="ri-phone-line ms-1 align-middle"></i>
                  </button>
                </div>
              </div>
            </Card.Body>
              ...
              <Card className="custom-card contactus-form overflow-hidden">
                ...
                <Card.Body>
                  <div className="row gy-3">
                    <Col xl={6}>
                      <Form.Label htmlFor="contact-address-firstname">
                        First Name :
                      </Form.Label>
                      <Form.Control
                        type="text"
                    ...
                    <Col xl={6}>
                      <Form.Label htmlFor="contact-address-lastname">
                        Last Name :
                      </Form.Label>
                      <Form.Control
                        type="text"
                    ...
                    <Col xl={6}>
                      <Form.Label htmlFor="contact-address-phone">
                        Phone No :
                      </Form.Label>
                      <Form.Control
                        type="text"
                    ...
                    <Col xl={6}>
                      <Form.Label htmlFor="contact-address-email">
                        Email Id :
                      </Form.Label>
                      <Form.Control
                        type="email"
                    ...
                    <Col xl={6}>
                      <Form.Label htmlFor="contact-address-address">
                        Address :
                      </Form.Label>
                      <Form.Control
                        as="textarea"
                    ...
                    <Col xl={6}>
                      <Form.Label htmlFor="contact-mail-message">
                        Message :
                      </Form.Label>
                      <Form.Control
                        as="textarea"
